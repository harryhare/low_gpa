...
* [WES 认证](wes.md)
  ...
  - WES 有个郁闷的点，就是成绩单中的 ABCD 会原封不动的保留
    国内绝大多数学校 的 A 的百分之分数是比 WES 的 A 对应的百分之分数高的
    所以如果成绩单中 ABCD 类型的分数多，是很吃亏的 
...
```text
todo：待更新
CMU MSE(MSE 要求至少两年工作经验，但是语言成绩要求比较高)
...
## 其他资源
[不同学校的 GPA 对照](https://gpa.eng.uci.edu/ )
